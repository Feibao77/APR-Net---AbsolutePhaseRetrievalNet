...
def parse_args():
    import argparse
    parser = argparse.ArgumentParser(description="pytorch APR-Net validation")

    parser.add_argument("--data-path", default="./", help="APR root")
    parser.add_argument("--weights", default="./APRNet_full.pth")
